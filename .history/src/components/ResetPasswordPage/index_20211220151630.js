  ...
  return (
    <div className="reset-password-page">
      ...
      <form autoComplete="off" className="reset-password-page__form" onSubmit={handleChangePasswordFormSubmit}>
        ...
        {isError && <p className="reset-password-page__error">Erreur survenue lors de l'envoi. Veillez vérifier que vos mots de passe soient identiques.</p>}
      ...
      {isSubmitted
        ...
        <div className="reset-password-page__validation">
          ...
          <p className="reset-password-page__validation-subtext">
            Votre mot de passe a bien été réinitialiser. Vous pouvez maintenant vous connecter.
          </p>
          <Link to="/connexion">
            <button
              type="submit"
