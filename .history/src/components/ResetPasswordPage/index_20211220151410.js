  ...
  return (
    <div className="reset-password-page">
      ...
      <form autoComplete="off" className="reset-password-page__form" onSubmit={handleChangePasswordFormSubmit}>
        ...
        {isError && <p className="reset-password-page__error">Erreur survenue lors de l'envoi. Veillez vérifier vos champs.</p>}
      ...
      {isSubmitted
        ...
        <div className="reset-password-page__validation">
          ...
          <p className="reset-password-page__validation-subtext">
            Un email de confirmation vous a été envoyé à l'adresse <span className="reset-password-page__validation-mail">{emailValue}</span>
          </p>
          <Link to="/connexion">
            <button
              type="submit"
