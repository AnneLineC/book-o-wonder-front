  ...
  return (
    <div className="contact-page">
      ...
      <p className="contact-page__contact">
        Vous pouvez nous contacter en envoyant un mail à : xxxxx@xxxxx.com <br></br>
      ...
      <form autoComplete="off" className="contact-page__form" onSubmit={handleSendFormSubmit}>
        ...
        <div className="contact-page__bottom">
          ...
          {isError && <p className="contact-page__error">Erreur survenue lors de l'envoi. Veillez vérifier vos champs.</p>}
        ...
        {isSubmitted
        && (
        <div className="contact-page__validation">
          <p className="contact-page__validation-title">
            Merci de votre message !
          </p>
          <p className="contact-page__validation-subtext">
            Merci pour votre message, nous y répondrons dès que possible
          </p>
          <Link to="/">
            <button
              type="submit"
              className="contact-page__home"
            >
              Retour à l'accueil
            </button>
          </Link>
