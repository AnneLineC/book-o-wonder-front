...

      {
        !isSubmitted
          ...
          ( <
            ...
            className = "ask-reset-page__form"
            onSubmit = {
              handleAskResetPasswordFormSubmit
            } >

            <
            label className = "ask-reset-page__label"
            htmlFor = "email" >
            <
            span className = "sr-only" > Votre adresse mail < /span> <
            input className = "ask-reset-page__input"
            type = "email"
            name = "email"
            id = "email"
...

        {
          isSubmitted
            ...
            ( <
              ...
              Un email de réinitialisation de votre mot de passe vous a été envoyé à l 'adresse <span className="register-page__validation-mail">{emailValue}</span> <
              /p> <
              Link to = "/connexion" >
              <
              button type = "submit"
